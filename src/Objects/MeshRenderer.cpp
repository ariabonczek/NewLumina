...
void MeshRenderer::Render(ID3D11DeviceContext* deviceContext)
{
	...
	p_Material->SetTexture2D("_Albedo", ResourceManager::LoadTexture2D("Textures/brick_diff.jpg", device), ShaderType::Pixel, deviceContext);
	p_Material->SetTexture2D("_Normal", ResourceManager::LoadTexture2D("Textures/brick_nor.jpg", device), ShaderType::Pixel, deviceContext);
